...
<section class="bg-color-1">
	<div class="wrap grid g-d-3 gap-2 pad-4">
		...
		<div class="column">
			...
			<p>Ea molestiae quo, aute! Impedit dicta porttitor asperiores, molestie molestias elit excepteur quis habitasse! Conubia.</p>
			<p class="read-more"><a href="#">Læs mere</a></p>
		</div>
		<div class="column">
			...
			<p>Elementum! Consectetuer est ex accumsan pulvinar, gravida non commodi risus! Mi pretium. habitasse! Conubia.</p>
			<p class="read-more"><a href="#">Læs mere</a></p>
		</div>
